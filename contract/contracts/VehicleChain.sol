...
contract VehicleChain {
    ...
    function checkIn(address walletAddress) public isRenter(walletAddress) {
        require(renters[walletAddress].active == true, "Please check out a vehicle first.");
        renters[walletAddress].active = false;
        renters[walletAddress].end = block.timestamp;
        setDue(walletAddress);
    }

    // Get total duration of vehicle use
    ...
    function canRentVehicle(address walletAddress) public isRenter(walletAddress) view returns(bool) {
